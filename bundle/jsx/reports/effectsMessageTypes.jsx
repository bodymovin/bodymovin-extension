...
$.__bodymovin.bm_reportsEffectMessages = (function () {
    ...
    var effectsMessages = {
        ...
        'ADBE Gaussian Blur 2': { name: 'Gaussian Blur', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        ...
        'ADBE Pro Levels2': { name: 'Levels (Individual Controls)', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        ...
        'ADBE Tint': { name: 'Tint', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        'ADBE Tritone': { name: 'Tritone', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        ...
        'ADBE Angle Control': { name: 'Angle Control', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        'ADBE Checkbox Control': { name: 'Checkbox Control', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        'ADBE Color Control': { name: 'Color Control', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        'ADBE Layer Control': { name: 'Layer Control', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        'ADBE Point Control': { name: 'Point Control', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        'ADBE Slider Control': { name: 'Slider Control', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        ...
        'ADBE Fill': { name: 'Fill', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
        ...
        'ADBE Drop Shadow': { name: 'Drop Shadow', messages:[{type: messageTypes.ERROR, renderers:[rendererTypes.BROWSER, rendererTypes.IOS, rendererTypes.ANDROID, rendererTypes.SKOTTIE]}]},
